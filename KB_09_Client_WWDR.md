# KB_09 — Client: Worldwide Developer Relations (Program Beta)
### SDS Compliance Procedure — CP001
Last Updated: May 2026

---

> **This document is self-contained.** You can work an entire Program Beta case from this doc alone.
...
| **SLA** | 48 hours |
| **Suspend** | Not available for Program Beta — Clear or Escalate only |
...
Worldwide Developer Relations is the Apple team supporting developers globally. The Program Beta compliance client screens developer enrollments into the Apple Developer Program. These cases screen anyone enrolling — both individuals at the precheck stage, and the organization at the final enrollment stage.
...
Program Beta has two event types. **Both must be notated in every Case Overview.**
...
> ⚠️ **IP Location and Ekata screenshot are required for all Program Beta cases.** Click the SILPH icon next to the Screened Entity name in CMS to auto-open Ekata with pre-filled data. Screenshot and save as `EKATA.PNG`.
...
1. In the Notes section, locate the **Program Beta_PII** entry and click the attachment
...
> ⚠️ **Program Beta has no Suspend option.** If you cannot clear, escalate.
...
Client & Event: Program Beta, rt_enrollment_final
Entity Type: Company
