# KB_10 — Client: IdentityCore (Program C)
### Risk Intelligence Procedure — CP000
Last Updated: May 2026

---

> **This document is self-contained.** You can work an entire Program C case from this doc alone.
...
IdentityCore provides authentication and authorization for all Apple identities. The Program C compliance client screens Apple IDs when customers in **high-risk countries** add a payment method to their Apple Wallet. Phase 1 covers **35 high-risk countries**.
...
## Lifecycle of an Program C Case
...
**Step 3b: Year of Birth shortcut** *(Program C-specific)*
...
> ⚠️ Previously submitted PII from a related case may **only** be used if the previous case was also an Program C case.
